...
std::uniform_int_distribution<std::mt19937::result_type> distribution(0,length-1);


int response(int length){
...
int main(int argc, char const *argv[])
{
	...
	while(true)
	{
		...
		std::cout <<"You chose "<<rules[input%length]<<" & Computer chose "<<rules[res]<<'\n'; 
